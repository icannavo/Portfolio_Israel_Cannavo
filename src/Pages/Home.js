                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                                              Hi everyone! I'm excited to be here today and tell you a bit about myself.
                                              I'm a passionate full-stack developer with a strong desire to create
                                              user-friendly and efficient applications. 
                                              I'm a strong believer in Agile development methodologies. These approaches
                                              focus on iterative development, which allows for continuous improvement and
                                              adaptation.  I'm a team player who thrives in collaborative environments and
                                              excels at clear communication to ensure project success.  Additionally, I'm
                                              adaptable and efficient, allowing me to work effectively in fast-paced and
              ...
              <div className="row love-row wow fadeIn">
                <div className="col-md-6">
                  <div className="skill-details text-left">
                                      <p> I'm always eager to learn and grow as a web developer,
                                          and I've gained valuable experience in various technologies
                                          that are essential for building modern websites. I'm proficient
                                          in the fundamentals and  allow me to create the core structure
                                          and functionality. I'm also exploring more advanced frameworks
                                          like Angular, React, and .NET, which open up possibilities for
                                          building complex and interactive applications. Additionally,
                                          I'm learning about databases, APIs for data exchange, and cloud
                                          platforms like Azure DevOps, which can streamline the development
                                          and deployment process. While I'm still on a journey of continuous
                                          learning, I'm passionate about using my skills to create user-friendly
                    ...
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                                              <p>
                                                  <a
                            href="https://cursos.dankicode.com/api/certificados/0ab0d429-d8f8-453a-b15f-8b401d9a9ff3"
                            target="_blank"
                          ...
                          >
                            ...
                            <p>Danki Code offers online programming, web development and design courses.
                               They provide access to practical and theoretical classes, allowing students
                               to learn essential skills for game, website and app development</p>
                        </p>
                      </div>
                    </div>
                  </div>
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                                                          "Working with Israel was a real pleasure,
                                                                          and we look forward to future collaborations.
                                                                          He is a dependable developer who can be trusted
                                                                          to handle a project from start to finish."
                                      <br />
                                      <span>João Victor da Silva</span>
                                    </p>
                                  </blockquote>
                                </div>
                                <div className="item">
                                  <blockquote>
                                    <p>
                                                                          "Israel is an effective communicator with
                                                                          the determination and confidence to tackle
                                                                          challenging design scenarios. He navigates
                                                                          collaborative processes well, contributing
                                                                          to the production of high-quality work."
                                      <br />
                                      <span>Carlos Algusto de Souza</span>
                                    </p>
                                  </blockquote>
                                </div>
                                <div className="item">
                                  <blockquote>
                                    <p>
                                                                          Israel has done an excellent job overall.
                                                                          The design of the site is impressive, and
                                                                          the code is clean and efficient. I particularly
                                                                          appreciate the way he managed the translations
                                                                          portion of the site.
                                      <br />
                                      <span>Luiz Alberto Ferreira</span>
                                    </p>
                                  </blockquote>
                                </div>
                              </div>
